...
- `docs/DEPLOYMENT.md` unter `SeniorCare ZIP-Docker Deployment V1`
- `docs/UPDATE_SYSTEM.md` fuer ZIP-basierte Updates ohne Docker Registry

Aktueller V1-Standard:

```text
SeniorCare Docker Update = ZIP herunterladen + Dateien aktualisieren + docker compose up -d --build
```
