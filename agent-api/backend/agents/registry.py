...
def discover_agent_manifests(agent_filter: tuple[str, ...] | set[str] | list[str] | None = None) -> list[AgentManifest]:
    return _discover_agent_manifests(agent_filter=agent_filter)


def discover_all_agent_manifests() -> list[AgentManifest]:
    return _discover_agent_manifests(agent_filter=None)


def _discover_agent_manifests(agent_filter: tuple[str, ...] | set[str] | list[str] | None = None) -> list[AgentManifest]:
    allowed = set(agent_filter) if agent_filter is not None else None
    manifests = []
