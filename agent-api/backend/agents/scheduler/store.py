...
class SchedulerStore:
    ...
    def _platform_default_tasks(self) -> list[dict[str, Any]]:
        tasks = [
            ...
            {
                "name": "Frontlicht bei Heimkehr",
                "description": "Schaltet abends bei erkannter Heimkehr das Frontlicht kurzzeitig ueber den Household Context ein.",
                "schedule_type": "cron",
                "schedule": {"cron": "*/1 * * * *", "timezone": "Europe/Berlin"},
                "target_agent": "household",
                "target_action": "front_light_on_arrival",
                "action_type": "household_check",
                "action_payload": {"comfort": "front_light", "apply": True},
                "source": "platform",
                "default_key": "platform:household:front-light-arrival",
            },
            {
                "name": "Garage Kontextsteuerung",
                "description": "Oeffnet oder schliesst die Garage ueber Home Assistant, wenn der ContextService READY_TO_OPEN oder READY_TO_CLOSE meldet.",
                "schedule_type": "cron",
                "schedule": {"cron": "*/1 * * * *", "timezone": "Europe/Berlin"},
                "target_agent": "household",
                "target_action": "garage_context_control",
                "action_type": "household_check",
                "action_payload": {"automation": "garage", "apply": True},
                "source": "platform",
                "default_key": "platform:household:garage-context-control",
            },
            {
                "name": "Erdgeschoss Rollos Kontextsteuerung",
                "description": "Schliesst Erdgeschoss-Rollos bei Schlafkontext ohne Gaeste und oeffnet morgens nur die von Steve geschlossenen Rollos.",
                "schedule_type": "cron",
                "schedule": {"cron": "*/5 * * * *", "timezone": "Europe/Berlin"},
                "target_agent": "household",
                "target_action": "ground_floor_shutters_context_control",
                "action_type": "household_check",
                "action_payload": {"automation": "ground_floor_shutters", "apply": True},
                "source": "platform",
                "default_key": "platform:household:ground-floor-shutters-context-control",
            },
            {
