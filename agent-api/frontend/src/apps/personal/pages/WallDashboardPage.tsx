...
const WallEnergyChart = lazy(() => import('../components/wall/WallEnergyChart'));
...
function EnergySparkline({history}: { history: EnergyPowerPoint[] }) {
    return (
        <Suspense fallback={<div className="wall-energy-sparkline"><span>Lade Verlauf...</span></div>}>
            <WallEnergyChart history={history}/>
        </Suspense>
    );
}
