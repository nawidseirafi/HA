...
export function NotificationsPage() {
  ...
  return (
    <section className="seniorcare-page">
      ...
      <p className="seniorcare-page-lead">Nur betreuungsrelevante Hinweise gehoeren in diese Ansicht.</p>
      <div className="seniorcare-notification-list">
        {messages.length ? messages.map((message) => (
          <article className="seniorcare-notification" key={message.id}>
          ...
          <article className="seniorcare-notification">
