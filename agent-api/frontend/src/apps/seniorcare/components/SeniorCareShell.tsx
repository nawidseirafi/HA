...
type Props = {
  route: SeniorCareRoute;
  onNavigate: (route: SeniorCareRouteName, tab?: SeniorCareSettingsTab) => void;
  onLogout: () => void;
  children: ReactNode;
};
...
export function SeniorCareShell({ route, onNavigate, onLogout, children }: Props) {
  return (
