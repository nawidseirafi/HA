...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with patch.object(config, "resolve_api_path", side_effect=resolve), patch("socket.socket.connect", side_effect=RuntimeError("External network disabled in tests")):
            ...
            for pattern in ("test_home_hub.py", "test_telegram_agent.py", "test_household_safety.py", "test_household_front_light.py", "test_context_service.py", "test_agent_control.py", "test_scheduler_disabled_agent.py", "test_homeassistant_energy.py", "test_washing_machine.py", "test_vacuum_service.py"):
